    ...
    <div class="content">
        ...
        <div class="programs">
            <div class="program-card">
                <img src="TPC-IMAGES/contain.png" alt="Picture of Founder of TPC">
                <div class="program-label">Picture Of Founder Of TPC</div>
            </div>
        </div>
    </div>

    <div class="history-details">
        <h2>History Of TPC</h2>
        <p>
            Trinity Polytechnic College, located in Novaliches, Quezon City, is a private, non-profit, and church-related institution, founded in 1963, and is the first full-fledged educational institution organized from the concordat of the Episcopal Church in the Philippines and the Iglesia Filipina Independiente. 
        </p>
        <p>
            Trinity Polytechnic College, formerly known as Trinity College of Quezon City, was established in 1963 as an elementary, high school, and collegiate educational institution by the Protestant Episcopalians. 
        </p>
        <p>
            The college's establishment was made possible by a trust fund established by the Matthews and Gamble families, who were interested in the missionary work of the Episcopal Church. 
        </p>
        <p>
        ...
        <p>
            <strong>Mission and Vision:</strong> The institution aims to provide a comprehensive education with a focus on Christian values and preparing students for leadership roles in a humane society.
        </p>
    </div>
